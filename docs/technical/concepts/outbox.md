...
> **Q: What delivery guarantee does the pattern provide, and what does that require of consumers?**
...
> **Q: How does CDC relate to the Outbox pattern, and when does polling suffice?**
...
> **Q: When should you use the Outbox pattern instead of alternatives?**
