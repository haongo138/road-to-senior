...
::: details Q: What is cache-aside (lazy loading) and why is it the most common strategy?
...
::: details Q: How does read-through differ from cache-aside?
...
::: details Q: What is write-through caching and what problem does it solve?
...
::: details Q: When would you use write-back (write-behind) caching?
...
::: details Q: What is write-around and when does it make sense?
...
::: details Q: How do you choose a strategy based on read/write ratio and consistency need?
